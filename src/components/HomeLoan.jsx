...
const HomeLoan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await fetch('http://localhost:8008/api/home-loan', {
          method: 'POST',
          headers: {
  ...
  return (
    <div className="max-w-lg mx-auto mt-8 p-8 border rounded shadow-md">
      <h2 className="text-2xl text-white font-bold mb-4">Home Loan Application</h2>
...
<div className="flex flex-col">
          <label htmlFor="propertyAddress" className="text-sm font-medium text-gray-600">
            Property Address:
          </label>
          <input
            type="text"
        ...
        <div className="flex flex-col">
          <label htmlFor="propertyValue" className="text-sm font-medium text-gray-600">
            Property Value:
          </label>
          <input
            type="number"
