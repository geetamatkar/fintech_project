...
const AutoLoan = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
        const response = await fetch('http://localhost:8008/api/auto-loan', {
          method: 'POST',
          headers: {
  ...
  return (
    <div className="max-w-lg mx-auto mt-8 p-8 border rounded shadow-md">
      <h2 className="text-2xl text-white font-bold mb-4">Auto Loan Application</h2>
...
<div className="flex flex-col">
        ...
        <div className="flex flex-col">
        <label htmlFor="makeAndModel" className="text-sm font-medium text-gray-600">
        ...
        <div className="flex flex-col">
        <label htmlFor="purchasePrice" className="text-sm font-medium text-gray-600">
            Purchase Price:
        </label>
        <input
            type="number"
        ...
        <div className="flex flex-col">
        <label htmlFor="VIN" className="text-sm font-medium text-gray-600">
        ...
        <div className="flex flex-col">
        <label htmlFor="yearOfManufacture" className="text-sm font-medium text-gray-600">
            Year of Manufacture:
        </label>
        <input
            type="number"
